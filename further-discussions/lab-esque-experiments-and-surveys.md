...
1. **External generalizability:** How much does behavior in '(contrived/artificial/lab-based)' experiments tell us about behavior in the real world? \[DR: or about _responses_ to different presentations?]
...
1. **'What is the best outcome variable to use?'**
