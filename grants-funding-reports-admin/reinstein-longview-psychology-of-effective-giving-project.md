...
*   **Brought together**
    ...
    **Our team**  is listed [HERE](../organization-and-overview/our-team-and-resources/).  We have held a number of small-group meetings, sharing our plans and advice. First '[monthly general meeting](../tip-o-the-spear/#meeting-agendas)': scheduled for 1 Dec. 2021 (see [#meeting-agendas](../tip-o-the-spear/#meeting-agendas "mention"))
...
* Worked to push forward and encourage **several marketing trials, some of which are underway** (including some with data and results; see '[tip-o-the-spear](../tip-o-the-spear/)' and  links to preliminary results);&#x20;
