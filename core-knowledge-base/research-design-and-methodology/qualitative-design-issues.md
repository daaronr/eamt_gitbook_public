...
In the present context, we have posted about our owrk, in general terms, on a public forum ([EA forum post](broken-reference)). Thus the idea that ‘people are running experiments to promote effective giving and EA ideas’ is not a well-kept secret. If participants in our experiments and trials are aware of this it may affect their choices and responses to treatments. This general set of problem is referred to in various ways, referring to different aspects of this; see 'experimenter demand', 'desirability bias', 'arbitrary coherence/coherent arbitrariness', observer bias (?), etc.
...
* Design study to measure 'cheap' behavior like 'clicks' (easier to observe, quicker feedback) versus meaningful and long-run behavior (like donations and pledges)
  * attribution issues
  * attrition issues (but also see the [quant](experimental-design-methods-issues/) section)
* Choice of impact measure/metric (also see the [quant](experimental-design-methods-issues/) section)
