...
See [google-a-b-optimize-analytics-interface.md](../../implementation-and-practical-tips/collecting-data-trial-outcomes/google-a-b-optimize-analytics-interface.md "mention") for notes, questions, and discussion of how this is documented and reported (and implemented).
